...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <!--<div class="main-text">Электроснабжение</div>-->
            <div class="row">
                <div class="col-md-4">
                    <?= $this->render('_menu') ?>
                </div>
                <div class="col-md-8">
                    <!--<div class="headline-block-left">
                        <div class="headline-li-right">
                            <span><a href="#">Главная</a></span><span>&#8250;</span><span><a href="index.html"> Лк </a></span><span>&#8250;</span><span>Электроснабжение</span>
                        </div>
                    </div>-->
                    <h1 class="page-header">Электроснабжение</h1>
